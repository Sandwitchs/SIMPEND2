...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | SIMPEND</title>
...
<body>
    ...
    <nav class="nav">
        <a href="<?php echo e(Auth::check() && Auth::user()->isAdmin() ? route('admin.dashboard') : (Auth::check() ? route('pendaki.dashboard') : route('login'))); ?>" class="logo">⛰️ SIMPEND</a>
        <div>
            <a href="<?php echo e(route('orang-hilang.public')); ?>">🔍 Orang Hilang</a>
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>">Login</a>
                <a href="<?php echo e(route('register')); ?>">Register</a>
            <?php else: ?>
                <?php if(Auth::user()->role == 'pendaki'): ?>
                <a href="<?php echo e(route('pendaki.notifications')); ?>" style="position: relative; margin-right: 20px;">
                    🔔 Notifikasi
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>" style="display: inline; margin-left: 15px;">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\SIMPEND\simpend-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>