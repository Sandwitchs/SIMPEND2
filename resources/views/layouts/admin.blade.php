...
<head>
    ...
    <title>@yield('title') | SIMPEND Admin</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('admin.gunung.index') }}" class="{{ request()->routeIs('admin.gunung.*') ? 'active' : '' }}">🏔️ Data Gunung</a>
        <a href="{{ route('admin.orang-hilang.index') }}" class="{{ request()->routeIs('admin.orang-hilang.*') ? 'active' : '' }}">👤 Orang Hilang</a>
        <a href="{{ route('admin.blacklist.index') }}" class="{{ request()->routeIs('admin.blacklist.*') ? 'active' : '' }}">🚫 Daftar Blacklist</a>
        <a href="{{ route('admin.manifes') }}" class="{{ request()->routeIs('admin.manifes') ? 'active' : '' }}">📋 Cetak Manifes</a>
