...
<div class="stats-container">
    ...
    <div class="stat-card-premium active-climbers">
        ...
        <div class="value">{{ $sedang_mendaki }} <span style="font-size: 14px; font-weight: 500; color: #9ca3af;">Kelompok</span></div>
    </div>
    <div class="stat-card-premium blacklist">
        <div class="label">🚫 Total Blacklist</div>
        <div class="value">{{ $total_blacklist }} <span style="font-size: 14px; font-weight: 500; color: #9ca3af;">NIK</span></div>
    </div>
</div>
...
<div class="stats-container" style="margin-bottom: 32px;">
    ...
    <div class="stat-card-premium approved">
        ...
        <div class="value" style="color: #34d399;">{{ $disetujui }}</div>
    </div>
    <div class="stat-card-premium rejected">
        <div class="label">❌ Ditolak</div>
        <div class="value" style="color: #f87171;">{{ $ditolak }}</div>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge badge-{{ $p->status_verifikasi }}">
                            {{ strtoupper($p->status_verifikasi) }}
                        </span>
                    </td>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('admin.pendaftaran.show', $p->id) }}" class="btn btn-primary btn-sm">Detail</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Data Gunung
        const labelGunung = @json($labelGunung);
        const dataGunung = @json($dataGunung);
